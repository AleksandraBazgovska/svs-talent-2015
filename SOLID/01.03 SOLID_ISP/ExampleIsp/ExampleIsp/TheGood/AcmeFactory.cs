...
{
    public class AcmeFactory : IFactory, ICarFactory, IBikeFactory, IMotorcycleFactory, IPaintBike, IPaintCar, IPaintMotorcycle
    {
        /// <summary>
        /// Implementirani osnovnite metod za proizvotstvo od IFactory interface
        /// </summary>
